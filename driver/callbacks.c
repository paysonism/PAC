                       ...
                       _In_ POB_PRE_OPERATION_INFORMATION OperationInformation)
{
        ...
        {
                /*
                 * WerFault interferes with our anti cheat (win11) and fucks itself.
                 * We are allowing it to run for now however cheaters may use this to their advantage.
                 *
                 * We need to perform system checks like maybe searching for a certificate.
                 */
